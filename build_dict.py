...
def build_dict(corpus, stopwords=None, measure='IDF'):
    ...
    '''
    @param corpus:    a list of tweets, represented as lists of (stemmed)
                      words
    @param stopwords: the list of (stemmed) words that should have zero weight
    					(Will mainly include pronouns)
...
def build_dict_from_tweets(output_file, corpus_files, stopwords_file=None,
...
if __name__ == '__main__':
    ...
    build_dict_from_tweets(output_file, corpus, stopwords_file, verbose=True)